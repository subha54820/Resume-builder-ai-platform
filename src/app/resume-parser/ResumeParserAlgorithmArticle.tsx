      ...
      <CardContent>
        <div className="prose max-w-none">
          <p className="text-muted-foreground">
            Our resume parser uses advanced PDF parsing technology to extract text and structure from resume documents.
          </p>
          <h3 className="text-lg font-semibold mt-4 mb-2">Parsing Steps:</h3>
          <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
            <li>Extract raw text content from PDF using pdfjs-dist</li>
            <li>Identify sections (Education, Experience, Skills, etc.)</li>
            <li>Parse structured data from each section</li>
            <li>Apply AI enhancement to improve accuracy</li>
            <li>Format and display parsed resume data</li>
          </ol>
        </div>
      </CardContent>
    </Card>
